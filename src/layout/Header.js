    ...
    <div className={(menuOpen ? "flex flex-grow items-center" : "hidden")+" lg:block"}>
                    <ul className={(menuOpen ?"flex flex-col list-none":"inline-flex")} >
                        ...
                        <li className="nav-item">
                            <a className="px-4 hover:text-blue-800" href="#" onClick={()=>appActions.setOption1()}>Ejercicio 1</a>
                        </li>
                        <li className="nav-item">
                            <a className="px-4 hover:text-blue-800" href="#" onClick={()=>appActions.setOption2()}>Ejercicio 2</a>
                        </li>
                        <li className="nav-item">
                            <a className="px-4 hover:text-blue-800" href="#" onClick={()=>appActions.setOption3()}>Ejercicio 3</a>
                        </li>
                    </ul>
    </div>
</div>
